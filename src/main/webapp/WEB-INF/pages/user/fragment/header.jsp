             ...
             <li class="nav-item dropdown dropleft">
                  ...
                  <div class="dropdown-menu">
                      <sec:authorize access="hasRole('ROLE_ADMIN')">
                          <a target="_blank" class="dropdown-item" href="${pageContext.request.contextPath}/management/adminHome">Manage Control</a>
                      </sec:authorize>
                      <sec:authorize access="hasRole('ROLE_STAFF')">
                           <a target="_blank" class="dropdown-item" href="${pageContext.request.contextPath}/management/adminHome">Manage Account Number</a>
                      </sec:authorize>
                    <a class="dropdown-item" href="${pageContext.request.contextPath}/profileManager">Quản lý hồ sơ</a>
                    <a class="dropdown-item" href="${pageContext.request.contextPath}/transactionHistory">Lịch sử giao dịch</a>
