...
public class LoginController {
    ...
    public String register(Model model) throws MessagingException, ParseException {
        ...
        boolean add = userService.addRegister(model, userName, password, customerName,
                customerEmail, customerPhone, passwordAgain, CINumber, issueDate,
                issuePlace, captcha);
        if (add == true) {
            ...
            model.addAttribute("CINumber", CINumber);
            model.addAttribute("issueDate", issueDate);
            model.addAttribute("issuePlace", issuePlace);
...
//checkEmailPhone
    ...
    public String checkEmailPhoneAndUserName(Model model) throws MessagingException {
        ...
        boolean check = changePasswordService.checkEmailAndUserName(model, userName, email);
        if (check == true) {
